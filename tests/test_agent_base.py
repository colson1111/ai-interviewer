...
from interviewer.core import (
    InterviewContext, AgentMessage, AgentResponse, AgentCapability, MessageType
)
...
class MockAgent(BaseInterviewAgent):
    ...
    def __init__(self, name: str = "mock_agent", capabilities: List[AgentCapability] = None):
...
class TestPerformanceMetrics:
    ...
    def test_update_metrics_multiple_requests(self):
        ...
        assert agent.performance_metrics['average_response_time'] == 0.5  # (0.4 + 0.6) / 2
...
class TestAgentStatus:
    ...
    def test_get_status_basic(self):
        ...
        agent = MockAgent(name="status_test", capabilities=[AgentCapability.INTERVIEW_QUESTIONS])
...
class TestAgentStringRepresentation:
    ...
    def test_str_representation(self):
        """Test __str__ method."""
        agent = MockAgent(name="string_test", capabilities=[AgentCapability.INTERVIEW_QUESTIONS])
...
class TestAgentProcessing:
    ...
    @pytest.mark.asyncio
    async def test_process_returns_response(self, interview_context, sample_user_message):
