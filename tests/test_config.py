...
from interviewer.config import (
    ...
    PROVIDER_MODELS, DEFAULT_MODELS, get_available_models, validate_model_for_provider
)
...
class TestProviderModels:
    ...
    def test_validate_model_for_provider_invalid(self):
        ...
        assert validate_model_for_provider(LLMProvider.OPENAI, "nonexistent-model") is False
