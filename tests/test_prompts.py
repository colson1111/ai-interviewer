...
class TestBuildSystemPrompt:
    ...
    def test_build_basic_prompt(self):
        ...
        prompt = build_system_prompt(
            interview_type="behavioral", tone="professional", difficulty="medium"
        )
    ...
    def test_build_prompt_includes_tone(self):
        ...
        prompt = build_system_prompt(
            interview_type="behavioral", tone="challenging", difficulty="medium"
        )
    ...
    def test_build_prompt_includes_difficulty(self):
        ...
        prompt = build_system_prompt(
            interview_type="behavioral", tone="professional", difficulty="hard"
        )
        ...
        for tone in tones:
            for difficulty in difficulties:
                for interview_type in interview_types:
                    prompt = build_system_prompt(
                        interview_type=interview_type, tone=tone, difficulty=difficulty
                    )
    ...
    def test_build_prompt_fallback_unknown_tone(self):
        ...
        prompt = build_system_prompt(
            interview_type="behavioral", tone="unknown_tone", difficulty="medium"
        )
    ...
    def test_build_prompt_fallback_unknown_type(self):
        ...
        prompt = build_system_prompt(
            interview_type="unknown_type", tone="professional", difficulty="medium"
        )
    ...
    def test_case_study_prompt_different_from_behavioral(self):
        ...
        case_study_prompt = build_system_prompt(
            interview_type="case_study", tone="professional", difficulty="medium"
        )
    ...
    def test_difficulty_affects_prompt_length(self):
        ...
        easy_prompt = build_system_prompt(
            interview_type="behavioral", tone="professional", difficulty="easy"
        )
