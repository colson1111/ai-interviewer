...
class MultiAgentInterviewSystem:
    ...
    def _create_agents(self):
        ...
        # Primary interview agent for conversation and questions
    ...
    async def get_initial_message(self, context: InterviewContext) -> AgentResponse:
        ...
        """
        # Create initial message from interview agent
        initial_message = await self.interview_agent.process(
            AgentMessage(
                sender="system",
    ...
    async def process_message(self, user_message: str, context: InterviewContext) -> Dict[str, Any]:
        """
...
def create_multi_agent_interview_system(llm_config: LLMConfig, interview_config: InterviewConfig) -> MultiAgentInterviewSystem:
    """
