...
class ContextualFeedback:
    ...
    def generate_contextual_strengths(
        self, metrics: AssessmentMetrics, response_type: str
    ) -> List[str]:
    ...
    def generate_contextual_improvements(
        self, metrics: AssessmentMetrics, response_type: str
    ) -> List[str]:
    ...
    def generate_contextual_suggestions(
        ...
        if response_type == "technical":
            ...
            if metrics.technical_depth < 0.6:
                suggestions.append(
                    "Explain the technical reasoning behind your approach"
                )
    ...
    def generate_contextual_technical_insights(
        self, metrics: AssessmentMetrics, response_type: str
    ) -> List[str]:
    ...
    def generate_contextual_communication_tips(
        self, metrics: AssessmentMetrics, response_type: str
    ) -> List[str]:
        ...
        if response_type == "technical":
            ...
            if metrics.structure < 0.6:
                tips.append(
                    "Structure behavioral responses with clear beginning, middle, and end"
                )
            ...
            if metrics.communication_style < 0.7:
                tips.append(
                    "Maintain confident, authoritative tone when discussing leadership"
                )
    ...
    def get_contextual_display_metrics(
        self, metrics: AssessmentMetrics, response_type: str
    ) -> Dict[str, float]:
