...
class CostTracker:
    ...
    def add_text_call(self, provider: str, model: str, input_tokens: int, output_tokens: int) -> float:
    ...
    def _calculate_text_cost(self, provider: str, model: str, input_tokens: int, output_tokens: int) -> float:
