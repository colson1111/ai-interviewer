...
class InterviewReport(BaseModel):
    ...
    strengths: List[str] = Field(
        description="List of candidate's demonstrated strengths"
    )
    improvements: List[str] = Field(description="List of areas for improvement")
    technical_assessment: Optional[str] = Field(
        description="Assessment of technical knowledge (if applicable)", default=None
    )
    communication_assessment: str = Field(
        description="Assessment of communication skills"
    )
    cultural_fit_assessment: str = Field(
        description="Assessment of cultural fit and behavioral traits"
    )
