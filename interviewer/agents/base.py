...
class BaseInterviewAgent(ABC):
    ...
    def update_performance_metrics(self, response: AgentResponse, response_time: float):
        ...
        ):  # Consider responses with >50% confidence as successful
        ...
        self.performance_metrics["average_confidence"] = (
            current_avg_confidence * (total_requests - 1) + response.confidence
        ) / total_requests
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "pydantic_agent_status": str(self.pydantic_agent)
